          ...
          <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 md:justify-between">
            <div className=" w-full">
              ...
              <input
                type="text"
                id="first_name"
                className="checedkbox  w-full p-1 pl-2 border-2 rounded-lg focus:outline-none"
            ...
            <div className=" w-full">
              ...
              <input
                type="text"
                id="last_name"
                className="checedkbox flex-1 w-full p-1 pl-2 border-2 rounded-lg  focus:outline-none"
                placeholder="Enter your first name"
              />
            </div>
          </div>
