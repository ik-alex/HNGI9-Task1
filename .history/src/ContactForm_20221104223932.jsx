    ...
    <>
      <section className="container mx-auto p-6 py-8 md:max-w-2xl">
        ...
        >
          ...
          <div className=" mb-4">
            <div className="checkbox-container flex space-x-2 items-center ">
              <input
                type="checkbox"
                id="confirm"
                className="p-1 pl-2 border-2 border-backgroundBlue rounded-lg  focus:outline-none cursor-pointer opacity-0 absolute"
              />
              <label for="confirm" className="cursor-pointer flex text-lg">
